    ...
    for (let i = 0; i < fields.length; i++) {
        fields[i].addEventListener("ripple", function (e) {
            if (JSON.stringify(e.detail.particle)) {
                ResourceGainHandler_1.ResourceGainHandler.gainResource(ResourceGainHandler_1.ResourceGainHandler.getParticleResourceFromField(e.detail.particle, new bignumber_js_1.BigNumber("1")), (e.detail.x - 10), (e.detail.y + 100));
            }
        });
    }
